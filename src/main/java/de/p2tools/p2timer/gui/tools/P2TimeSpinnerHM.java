...
public class P2TimeSpinnerHM extends Spinner<LocalTime> {
    ...
    enum Mode {
        HOURS {
            ...
            @Override
            void select(P2TimeSpinnerHM spinner) {
        ...
        MINUTES {
            ...
            void select(P2TimeSpinnerHM spinner) {
                ...
                String s = spinner.getEditor().getText();
                int l = spinner.getEditor().getText().length();
            }
        };

        abstract LocalTime increment(LocalTime time, int steps);

        abstract void select(P2TimeSpinnerHM spinner);
    ...
    public P2TimeSpinnerHM() {
        this(LocalTime.now());
    }

    public P2TimeSpinnerHM(LocalTime time) {
        setEditable(true);
        ...
        SpinnerValueFactory<LocalTime> valueFactory = new SpinnerValueFactory<>() {
            ...
            public void decrement(int steps) {
                ...
                mode.get().select(P2TimeSpinnerHM.this);
            }
